...
var number2cnText = utils.number2cnText;
...
var ApprovalPaymentTable = function ApprovalPaymentTable(_ref3) {
  ...
  var RemarkSlot = _ref3.RemarkSlot,
    ...
    incomeInfo =
      _ref3$incomeInfo === void 0 ? defaultIncomeInfo : _ref3$incomeInfo,
  ...
  var now = moment().locale('zh-cn').format('YYYY-MM-DD').split('-');
  var _useState5 = useState(defaultFocus),
    ...
    (_Object$keys = Object.keys(defaultFocus)) === null ||
      ...
      : _Object$keys.reduce(function (pre, curr) {
          return _objectSpread(
            _objectSpread({}, pre),
            {},
            _defineProperty({}, curr, useRef(null)),
          );
        }, {}),
  );
  useOnFatherClick(
      ...
      /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            editType('date') &&
              /*#__PURE__*/ React.createElement(_DatePicker, {
                ...
                placeholder:
                  ((focus === null || focus === void 0 ? void 0 : focus.date) &&
                    '请选择付款日期') ||
                  '',
                style: {
                  width: '100%',
        ...
        /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            RemarkSlot &&
              /*#__PURE__*/ React.createElement(RemarkSlot, {
                info: paymentInfo,
              }),
          ),
        ),
...
var API_paymentInfoType = function API_paymentInfoType() {
  return null;
};
