...
async function checkLocalCommit() {
  ...
  if (stdout.includes(`git push`)) {
    console.log(
      '\x1B[31m请前往"https://github.com/bhz246810/company-component-next"提交合并请求来发布您的本地提交\x1B[0m',
    );
    await cli(
      '前往"https://github.com/bhz246810/company-component-next"提交合并请求来发布您的本地提交',
    );
